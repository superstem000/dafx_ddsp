#!/usr/bin/env python3
"""
Baseline GWO Script for Task A
===============================
Optimized for 32 wolves / 125 iterations / Hybrid Loss
"""
...
def run_baseline_experiment(target_folder, wolves, iterations, output_dir, seed=42):
    print("=" * 60)
    print(f"GWO EXPERIMENT: {output_dir}")
    print("=" * 60)
...
def main():
    parser = argparse.ArgumentParser(description="DAFx GWO Runner")
    ...
    parser.add_argument('--out', type=str, default='results_gwo_32_125')
